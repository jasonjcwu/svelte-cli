...
Presets saved during `vue create` are stored in a configuration file in your user home directory (`~/.svelterc`). You can directly edit this file to tweak / add / delete the saved presets.
