...
const Creator = require('@svel/cli/lib/Creator')
const { getPromptModules } = require('@svel/cli/lib/util/createTools')
const { getFeatures } = require('@svel/cli/lib/util/features')
const { defaults } = require('@svel/cli/lib/options')
const { toShortPluginId, execa } = require('@svel/cli-shared-utils')
const { progress: installProgress } = require('@svel/cli/lib/util/installDeps')
